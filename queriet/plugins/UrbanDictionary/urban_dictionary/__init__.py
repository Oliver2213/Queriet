...
class urban_dictionary(PluginHandler.Plugin):
    ...
    def __init__(self):
        ...
        # We don't really need to do anything here, no api tokens required with
        # this package
...
class UrbanDictInfoPanel(PluginHandler.PluginPanel):
    ...
    def __init__(self, parent):
        ...
        self.InputPanel = StandardInputPanel(
            self,
            self.Search,
            InputFieldString='Urbandictionary Search',
            autohide=False,
